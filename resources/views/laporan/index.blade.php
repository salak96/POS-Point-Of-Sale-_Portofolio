...
@push('css')
<link rel="stylesheet" href="{{ ('sb-admin-2.min/plugins/daterangepicker/daterangepicker.css') }}">
...
@push('scripts')
<script src="{{ asset('/sb-admin-2.min/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<script>
    let table;
    $(function () {
